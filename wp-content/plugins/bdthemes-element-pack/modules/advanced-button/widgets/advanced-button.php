...
class AdvancedButton extends Widget_Base {
	...
	protected function _content_template() {
		...
		<div class="elementor-button-wrapper">
			<a class="bdt-ep-button bdt-ep-button-effect-{{ settings.button_effect }} bdt-ep-button-size-{{ settings.button_size }}{{animation}}{{attention}}" href="{{ settings.link.url }}" role="button" {{{ view.getRenderAttributeString( 'button' ) }}}>
