...
class Skin_Hazel extends Elementor_Skin_Base {
	...
	public function render_excerpt() {
		...
		$strip_shortcode = $this->parent->get_settings_for_display('strip_shortcode');
		...
		<div class="bdt-post-slider-text bdt-visible@m" bdt-slideshow-parallax="x: 500,-500">
			<?php
				if ( has_excerpt() ) {
					...
					echo element_pack_custom_excerpt($this->parent->get_settings_for_display('excerpt_length'), $strip_shortcode);
				}
            ?>
		</div>
		<?php
