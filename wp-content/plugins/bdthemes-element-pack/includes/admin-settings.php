    ...
    function element_pack_welcome() {
      ...
      <div class="ep-dashboard-panel"
        ...
        <div class="bdt-grid bdt-visible@xl" bdt-grid bdt-height-match="target: > div > .bdt-card">
          <div class="bdt-width-2-5@l ep-welcome-banner">
            <div class="ep-welcome-content bdt-card bdt-card-body">
              <h1 class="ep-feature-title">
                Welcome <?php echo esc_html($current_user->user_firstname); ?> <?php echo esc_html($current_user->user_lastname); ?>
                !</h1>
          ...
          <div class="bdt-width-2-5@l">
            <div class="bdt-card bdt-card-body bdt-card-red ep-genarate-idea">
              ...
              <p style="max-width: 690px;">
                Designing an element might be so tough, I might not able to do it! You often may think like that but
                it’s not true. We have made the best tutorials and walk through for each and every widgets that anyone
                will be able to do it. Lets visit the documentation web portal and learn more about your desired
                elements to make the next coolest website on the internet.
              </p>
          ...
          <div class="bdt-width-1-5@l">
            <div class="bdt-card bdt-card-body bdt-card-blue ep-facebook-community">
              ...
              <a class="bdt-button bdt-btn-blue bdt-margin-small-top" target="_blank" rel=""
                 href="https://www.facebook.com/groups/elementpack/">Join Now</a>
